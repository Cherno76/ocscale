...
export const TH: Record<"dark" | "light", Theme> = {
  dark: {
    ...
    surface: "linear-gradient(180deg, rgba(255,255,255,0.16), rgba(255,255,255,0.08))",
  ...
  light: {
    ...
    surface: "linear-gradient(180deg, rgba(255,255,255,0.88), rgba(255,255,255,0.70))",
